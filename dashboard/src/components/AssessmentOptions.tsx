...
const AssessmentOptions = ({fieldKey, airlines}: Props) => {
    ...
    return (
            <div className={"rounded px-3 relative border border-[#002454] p-3 w-80"}>
                ...
                <div className={"flex gap-3"}>
                    <input ref={inputRef} autoFocus={isEdit} id={fieldKey} value={airlinesName} onChange={(e) => setAirlines(e.target.value)} className={"outline-none border-0 w-full bg-transparent"} />
                    {
